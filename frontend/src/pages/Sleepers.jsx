      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-500">
            Players outperforming or underperforming their preseason draft rank, based on
            current trend score. Breakouts were ranked in the back half at their position
            preseason and are now trending up; Fallers were ranked near the top at their
            position preseason and are now trending down. See the{' '}
            <Link to="/about" className="text-ice-400 hover:underline">
              Methodology
            </Link>{' '}
            page for how Trend Score itself is calculated.
          </p>
        </div>
